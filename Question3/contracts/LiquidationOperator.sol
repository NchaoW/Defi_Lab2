...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function uniswapV2Call(
        ...
        console.log("uniswapV2Pair(%s): WETH <> USDC", address(uniswapV2Pair_USDC_WETH));
        ...
        console.log("liquidated %s USDC", debtToCover);
        console.log("liquidated %s WETH", WETH.balanceOf(address(this)));
        ...
        // 2.3 repay
        console.log("Balance WETH1: %s", WETH.balanceOf(address(this)));
        ...
        console.log("Balance WETH2: %s", WETH.balanceOf(address(this)));
