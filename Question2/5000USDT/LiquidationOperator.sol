...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function uniswapV2Call(
        ...
        console.log("AmountOfWBTC1: %s", WBTC.balanceOf(address(this)));
        console.log("getAmountIn: %s", getAmountIn(debtToCover, reserve_WBTC_Pool1, reserve_USDT_Pool1));
        ...
        console.log("AmountOfWBTC2: %s", WBTC.balanceOf(address(this)));

        //convert WBTC left to WETH
        console.log("AmountOfWETH1: %s", WETH.balanceOf(address(this)));
        ...
        console.log("AmountOfWETH2: %s", WETH.balanceOf(address(this)));
